...
from updateattackagaclipnorm import LocalUpdate, test_inference
    ...
    for local_it in list_local_it:
        ...
        for run in range(1,4):
            ...
            for epoch in tepoch:
                ...
                mia = AGA(args=args, dataset=train_dataset, target_model=global_model, 
                ...
                print ("AGA test accuracy:", mia_accuracy_val[-1])
                ...
                for idx in idxs_users:
                    ...
                    if(idx in attacked_users):
                        flag_value=1
                    else:
                        flag_value=0
                    
                    local_model = LocalUpdate(args=args, dataset=train_dataset,\
                                              idxs=user_groups[idx], logger=logger, fixed_train_sample=None,flag=flag_value)
                ...
                torch.save(ref_model.state_dict(), f"./Presentation_aga/ref_model_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{epoch}_{run}.pt")
                
                torch.save(attacker_model.state_dict(), f"./Presentation_aga/attacker_model_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{epoch}_{run}.pt")
                pickle.dump(mia.scaler,open(f"./Presentation_aga/scaler_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{epoch}_{run}.pkl",'wb'))
            ...
            print("|---- Avg AGA Accuracy: {:.2f}%".format(100 * np.mean([x[0] for x in mia_accuracy])))
            ...
            np.save(f"./Presentation_aga/X_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", X)
            np.save(f"./Presentation_aga/A_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", A)
            np.save(f"./Presentation_aga/b_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", b)
            np.save(f"./Presentation_aga/b_grads_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", b_grads)
            np.save(f"./Presentation_aga/ground_truth_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", ground_truth)
            np.save(f"./Presentation_aga/AGA_accuracy_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", mia_accuracy)
            np.save(f"./Presentation_aga/AGA_accuracy_val_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", mia_accuracy_val)
            np.save(f"./Presentation_aga/train_loss_test_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", train_loss_test)
            np.save(f"./Presentation_aga/train_accuracy_test_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", train_accuracy_test)
            np.save(f"./Presentation_aga/l_var_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_var)
            np.save(f"./Presentation_aga/l_var_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_var_pos)
            np.save(f"./Presentation_aga/l_var_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_var_neg)
            np.save(f"./Presentation_aga/l_mean_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean)
            np.save(f"./Presentation_aga/l_mean_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_pos)
            np.save(f"./Presentation_aga/l_mean_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_neg)
            np.save(f"./Presentation_aga/l_median_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_median)
            np.save(f"./Presentation_aga/l_median_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_median_pos)
            np.save(f"./Presentation_aga/l_median_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_median_neg)
            np.save(f"./Presentation_aga/l_mean_deviation_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_deviation_pos)
            np.save(f"./Presentation_aga/l_mean_deviation_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_deviation_neg)

            #pickle.dump((expB_err, expC_err,expC_err_ols,expC_err_reg),open("./Presentation_aga/exp_err_weights_"+str(args.attacker_model_reg)+"_"+str(args.penality)+"_"+str(args.dataset)+"_"+str(args.local_bs)+"_"+str(args.local_sgd_it)+"_"+str(run)+".pickle",'wb'))
