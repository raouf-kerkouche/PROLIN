...
def args_parser():
    ...
    parser.add_argument('--local_sgd_it', type=int, default=3,
                        help="Number of local SGD iterations (client training size: local_bs * local_sgd_iter)")
    parser.add_argument('--mia_sample_num', type=int, default=6000, #6000,
    ...
    parser.add_argument('--lr', type=float, default=0.01, #0.001, #0.01,
                        help='learning rate')
    parser.add_argument('--momentum', type=float, default=0.0,
                        help='SGD momentum (default: 0.5)')
    parser.add_argument('--attacker_model_reg', type=str, default='l2',
