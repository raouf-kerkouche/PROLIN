...
from updateattackinvadaptive import LocalUpdate, test_inference
    ...
    for local_it in list_local_it:
        ...
        for run in range(3,4):
            ...
            for epoch in tepoch:
                ...
                mia = INV(args=args, dataset=train_dataset, target_model=global_model, 
                ...
                print ("INV test accuracy:", mia_accuracy_val[-1])
                ...
                torch.save(ref_model.state_dict(), f"./Presentation_inv/ref_model_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{epoch}_{run}.pt")
                
                torch.save(attacker_model.state_dict(), f"./Presentation_inv/attacker_model_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{epoch}_{run}.pt")
                pickle.dump(mia.scaler,open(f"./Presentation_inv/scaler_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{epoch}_{run}.pkl",'wb'))
            ...
            print("|---- Avg INV Accuracy: {:.2f}%".format(100 * np.mean([x[0] for x in mia_accuracy])))
            ...
            np.save(f"./Presentation_inv/X_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", X)
            np.save(f"./Presentation_inv/A_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", A)
            np.save(f"./Presentation_inv/b_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", b)
            np.save(f"./Presentation_inv/b_grads_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", b_grads)
            np.save(f"./Presentation_inv/ground_truth_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", ground_truth)
            np.save(f"./Presentation_inv/INV_accuracy_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", mia_accuracy)
            np.save(f"./Presentation_inv/INV_accuracy_val_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", mia_accuracy_val)
            np.save(f"./Presentation_inv/train_loss_test_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", train_loss_test)
            np.save(f"./Presentation_inv/train_accuracy_test_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", train_accuracy_test)
            np.save(f"./Presentation_inv/l_var_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_var)
            np.save(f"./Presentation_inv/l_var_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_var_pos)
            np.save(f"./Presentation_inv/l_var_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_var_neg)
            np.save(f"./Presentation_inv/l_mean_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean)
            np.save(f"./Presentation_inv/l_mean_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_pos)
            np.save(f"./Presentation_inv/l_mean_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_neg)
            np.save(f"./Presentation_inv/l_median_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_median)
            np.save(f"./Presentation_inv/l_median_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_median_pos)
            np.save(f"./Presentation_inv/l_median_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_median_neg)
            np.save(f"./Presentation_inv/l_mean_deviation_pos_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_deviation_pos)
            np.save(f"./Presentation_inv/l_mean_deviation_neg_{args.optimizer}_{args.dataset}_{args.epochs}_{args.num_users}_{args.frac}_{args.local_bs * args.local_sgd_it}_{args.local_bs}_{args.local_sgd_it}_{args.attacker_model_reg}_{args.penality}_{args.prop}_weights_{run}.npy", l_mean_deviation_neg)

            #pickle.dump((expB_err, expC_err,expC_err_ols,expC_err_reg),open("./Presentation_inv/exp_err_weights_"+str(args.attacker_model_reg)+"_"+str(args.penality)+"_"+str(args.dataset)+"_"+str(args.local_bs)+"_"+str(args.local_sgd_it)+"_"+str(run)+".pickle",'wb'))
